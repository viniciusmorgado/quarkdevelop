...
|---|---|---|---|
| A | consistency analysis (duplication, ambiguity, constitution alignment, coverage) | 9 CRITICAL, 7 HIGH, 8 MEDIUM, 6 LOW; coverage 26/27 requirements | [review-A.md](review-A.md) |

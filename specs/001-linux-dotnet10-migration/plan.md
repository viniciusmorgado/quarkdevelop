...
| Some commits covered several tasks: f3064b6182, 8d97bf875e, b66afd6adf, a64d4a9899, 80be2b3d33, f04d07795e, 10a54b7c27, 0ecd61be05 | the toolchain, the first Core compile and the test harness were interdependent | splitting would have produced non-building commits; from constitution 1.2.0 every commit carries a `Tasks:` trailer enforced by `scripts/git-commit` |

...
namespace Microsoft.VisualStudio.Language.Intellisense
{
    ...
    public class BulkObservableCollection<T> : ObservableCollection<T>
    {
        ...
        // MonoDevelop local patch: WPF's Dispatcher is replaced by the SynchronizationContext of the thread
        // that created the collection (the GTK main loop in the IDE).
        private sealed class Dispatcher
        {
            ...
            public bool CheckAccess() => _context == null || SynchronizationContext.Current == _context;

            public void BeginInvoke(System.Delegate method, DispatcherPriority priority, params object[] args)
            {
                _context.Post(_ => method.DynamicInvoke(args), null);
            }
        }

        private enum DispatcherPriority
        {
            Send
        }
    }

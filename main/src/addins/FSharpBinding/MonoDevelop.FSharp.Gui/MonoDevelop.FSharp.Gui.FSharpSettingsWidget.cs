...
namespace MonoDevelop.FSharp.Gui
{
	public partial class FSharpSettingsWidget
	{
		...
		protected virtual void Build ()
		{
			...
			this.label4.LabelProp = global::MonoDevelop.Core.GettextCatalog.GetString("<b>F# Interactive</b>");
			...
			this.advanceToNextLineCheckbox.TooltipMarkup = global::MonoDevelop.Core.GettextCatalog.GetString ("When sending a line or an empty selection to F# interactive this property automatically advances to the next line.");
			this.advanceToNextLineCheckbox.CanFocus = true;
			this.advanceToNextLineCheckbox.Name = "advanceToNextLineCheckbox";
			this.advanceToNextLineCheckbox.Label = global::MonoDevelop.Core.GettextCatalog.GetString("Advance to next line");
			...
			this.label2.TooltipMarkup = global::MonoDevelop.Core.GettextCatalog.GetString ("This is only used when xbuild is not being used.");
			this.label2.Name = "label2";
			this.label2.LabelProp = global::MonoDevelop.Core.GettextCatalog.GetString("<b>F# Default Compiler</b>");
			...
			this.checkCompilerUseDefault.Label = global::MonoDevelop.Core.GettextCatalog.GetString("Use Default");
			...
			this.buttonCompilerBrowse.Label = global::MonoDevelop.Core.GettextCatalog.GetString ("_Browse...");
			...
			this.entryCompilerPath.Text = global::MonoDevelop.Core.GettextCatalog.GetString("1234");
			...
			this.label3.LabelProp = global::MonoDevelop.Core.GettextCatalog.GetString ("Path");
			...
			this.label8.LabelProp = global::MonoDevelop.Core.GettextCatalog.GetString("<b>F# Editor</b>");
			...
			this.checkHighlightMutables.Label = global::MonoDevelop.Core.GettextCatalog.GetString("Highlight mutable variables");
			...
			this.checkTypeSignatures.Label = global::MonoDevelop.Core.GettextCatalog.GetString ("Show function type signatures");

...
namespace MonoDevelop.Ide.Gui.OptionPanels
{
	partial class MonoRuntimePanelWidget
	{
		...
		protected virtual void Build ()
		{
			...
			this.textview1.Buffer.Text = global::MonoDevelop.Core.GettextCatalog.GetString ("If you have a parallel installation of Mono you can register it here, so you can use it for building and running projects. The <b>default runtime</b> is the .NET runtime to be used for building and running applications when none is specifically selected.");

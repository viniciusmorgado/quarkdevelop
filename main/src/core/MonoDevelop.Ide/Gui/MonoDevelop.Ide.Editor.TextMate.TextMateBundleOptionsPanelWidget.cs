...
namespace MonoDevelop.Ide.Editor.TextMate
{
	public partial class TextMateBundleOptionsPanelWidget
	{
		...
		protected virtual void Build()
		{
			...
			this.textview1.Buffer.Text = global::MonoDevelop.Core.GettextCatalog.GetString(@"Language bundles can provide new editor themes, code snippets, code completion items and other information to improve the editing experience of specific languages. Visual Studio for Mac supports: <b>TextMate (.tmBundle)</b> and <b>Sublime 3 (.sublime)</b> package files.");
